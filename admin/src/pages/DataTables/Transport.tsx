...
const Transport = () => {
    ...
    const handleSearch = () => {
        const filteredData = initialRecords.filter((record) => {
            return (
                (selectedTransport === '' || record.AGENTNAME === selectedTransport) &&
                ...
                <div className="mb-4.5 flex md:items-center md:flex-row flex-col gap-5">
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center flex-wrap">
                            ...
                            <button type="button" className="btn btn-primary btn-sm m-1" style={{ padding: '8px 28px' }} onClick={handleSearch}>
                                SEARCH
                            </button>
                                ...
                                <label htmlFor="">
                                    ...
                                    >
                                        ...
                                        {initialRecords.map((record, index) => (
                                            <option key={index} value={record.AGENTNAME}>
                                                {record.AGENTNAME}
                                            </option>
                                        ))}
                                    </select>
                        ...
                        <tr>
                            <td>
                                <label htmlFor="">
                                    ...
                                    <select
                                        name="City"
                                        style={{ border: '1px solid #e5e7eb', borderRadius: '5px', marginLeft: '84px', width: '144px' }}
                                        value={selectedCity}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--ALL--</option>
                                        ...
                                        {initialRecords.map((record, index) => (
                                            <option key={index} value={record.ACCITY}>
                                                {record.ACCITY}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <td>
                                <label htmlFor="">
                                    ...
                                    >
                                        ...
                                        {initialRecords.map((record, index) => (
                                            <option key={index} value={record.ACSTATE}>
                                                {record.ACSTATE}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <td>
                                <label htmlFor="">
                                    ...
                                    <select
                                        name="Status"
                                        style={{ border: '1px solid #e5e7eb', borderRadius: '5px', marginLeft: '32px', width: '144px' }}
                                        value={selectedStatus}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--All--</option>
                                        {initialRecords.map((record, index) => (
                                            <option key={index} value={record.STATUS}>
                                                {record.STATUS}
                                            </option>
                                        ))}
                                    </select>
