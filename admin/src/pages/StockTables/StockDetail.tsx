    ...
    return (
            ...
            <div className="panel mt-6">
                ...
                <table>
                    ...
                    <thead>
                        ...
                        <td>
                            <label htmlFor="">Shelf No.
                                <select name="Shelf No."
                                    style={{
                                        width: "144px",
                                        marginLeft: "82px",
                                        border: "1px solid #e5e7eb",
                    ...
                    <thead>
                        <td>
                            <label htmlFor="">Barcode From
                                <select name="Barcode From"
                                    style={{
                                        width: "144px",
                                        marginLeft: "3px",
                                        border: "1px solid #e5e7eb",
                        ...
                        <td>
                            <label htmlFor="">Barcode To
                                <select name="Barcode To"
                                    style={{
                                        width: "144px",
                                        marginLeft: "3px",
                                        border: "1px solid #e5e7eb",
                        ...
                        <td>
                            <label htmlFor="">MRP From
                                <select name="MRP From"
                                    style={{
                                        width: "144px",
                                        marginLeft: "3px",
                                        border: "1px solid #e5e7eb",
                        ...
                        <td style={{display:'flex', gap:'4px'}}>
                            ...
                            <label htmlFor="" style={{marginTop:'4px'}}>All
                            ...
                            <label htmlFor="" style={{marginTop:'4px'}}>+ve
        ...
        {initialRecords.map((record, index) => (
            <option key={index} value={record.APSTATE}>{record.APSTATE}</option>
                            ...
                            <label htmlFor="" style={{marginTop:'4px'}}>Zero
