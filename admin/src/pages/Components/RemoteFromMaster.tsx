...
const col = ['FormName', 'NAME', 'SEQUENCE'];
...
const RemoteFromMaster = () => {
    ...
    const [sortStatus, setSortStatus] = useState<DataTableSortStatus>({ columnAccessor: 'FormName', direction: 'asc' });
    ...
    const header = ['FormName', 'NAME', 'SEQUENCE'];
    ...
    const handleDownloadExcel = () => {
        const col: Array<keyof UserData> = ['FormName', 'NAME', 'SEQUENCE'];
        downloadExcel({
            fileName: 'table',
            ...
            <div className="panel mt-6">
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        records={recordsData}
                        columns={[
                            { accessor: 'FormName', title: 'FromName', sortable: true },
                            { accessor: 'FormName', title: 'Control', sortable: true },
                            { accessor: 'NAME', title: 'Name', sortable: true },
                            { accessor: 'NAME', title: 'Type', sortable: true },
                            { accessor: 'NAME', title: 'Value', sortable: true },
